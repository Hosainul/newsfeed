        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                  <div class="row">
                      ...
                      <div class="col-md-10">
                        <div class="form-group">
                          <input type="checkbox" id="publish" class="filled-in" name="status" value="1" required="">
          ...
          <div class="col-lg-12">
            <div class="card">
                ...
                <div class="body">
                  <textarea name="body" id="ckeditor" cols="30" rows="10" required=""></textarea>
                </div>
            </div>
          </div>
          
        </div>
        <a href="{{route('author.post.index')}}" class="btn btn-info btn-sm">Back</a>
