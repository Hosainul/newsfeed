...
<div class="content">
  <div class="container-fluid">
    <a href="{{route('author.post.create')}}" class="btn btn-primary">New Post</a>
    <div class="row">
      <div class="col-md-12">
        <div class="card">
              ...
              <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          <a href="{{route('author.post.edit',$post->id)}}"> <i class="material-icons">edit</i></a>
