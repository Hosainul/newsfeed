...
<div class="content">
  <div class="container-fluid">
    <a href="{{route('admin.photography.create')}}" class="btn btn-primary">New Photo</a>
    <div class="row">
      <div class="col-md-12">
        <div class="card">
              ...
              <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          <form id="delete-form-{{ $photo->id }}" action="{{route('admin.photography.destroy',$photo->id)}}" method="POST" style="display: none;">
                            @csrf
                            @method('DELETE')
                          </form>
