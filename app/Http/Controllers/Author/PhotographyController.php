...
class PhotographyController extends Controller
{
    ...
    {
        $photos = Auth::user()->photographies;
        return view('author.photography.index',compact('photos'));
    }
    ...
    {
        return view('author.photography.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('author.photography.index');
    }
